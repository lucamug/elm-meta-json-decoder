...
var _lucamug$elm_meta_json_decoder$Main$Model = F4(
	function (a, b, c, d) {
		return {metaThings: a, metaThingsApiError: b, metaThingsApiUrl: c, metaThingsApiStatus: d};
	});
var _lucamug$elm_meta_json_decoder$Main$Thing = F2(
	function (a, b) {
		return {id: a, name: b};
	});
var _lucamug$elm_meta_json_decoder$Main$thing = A3(
	...
	A3(
		...
		'id',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_lucamug$elm_meta_json_decoder$Main$Thing)));
var _lucamug$elm_meta_json_decoder$Main$things = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'things',
	...
	_elm_lang$core$Json_Decode$list(_lucamug$elm_meta_json_decoder$Main$thing));
var _lucamug$elm_meta_json_decoder$Main$MetaThings = F5(
	function (a, b, c, d, e) {
		return {id: a, rev: b, name: c, data: d, updated: e};
	});
var _lucamug$elm_meta_json_decoder$Main$metaThings = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'updated',
	_elm_lang$core$Json_Decode$string,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'data',
		_elm_community$json_extra$Json_Decode_Extra$doubleEncoded(_lucamug$elm_meta_json_decoder$Main$things),
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'name',
			_elm_lang$core$Json_Decode$string,
			A3(
				...
				A3(
					...
					'_id',
					_elm_lang$core$Json_Decode$string,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_lucamug$elm_meta_json_decoder$Main$MetaThings))))));
var _lucamug$elm_meta_json_decoder$Main$Error = {ctor: 'Error'};
var _lucamug$elm_meta_json_decoder$Main$Done = {ctor: 'Done'};
...
var _lucamug$elm_meta_json_decoder$Main$ChangeMetaThingsApi = function (a) {
	return {ctor: 'ChangeMetaThingsApi', _0: a};
};
var _lucamug$elm_meta_json_decoder$Main$FetchMetaThingsData = {ctor: 'FetchMetaThingsData'};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Decoding Json that contain Json'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_lucamug$elm_meta_json_decoder$Main$ChangeMetaThingsApi),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$value(model.metaThingsApiUrl),
							_1: {
								ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_lucamug$elm_meta_json_decoder$Main$FetchMetaThingsData),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Fetch Data'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(_elm_lang$core$Basics_ops['++'], 'Url: ', model.metaThingsApiUrl)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
								...
								{ctor: '[]'},
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(
											_elm_lang$core$Basics_ops['++'],
											'Status: ',
											_elm_lang$core$Basics$toString(model.metaThingsApiStatus))),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
									...
									},
									{
										...
										_0: _elm_lang$html$Html$text(
											A2(
												_elm_lang$core$Basics_ops['++'],
												'Ok: ',
												_elm_lang$core$Basics$toString(model.metaThings))),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
										...
										},
										{
											...
											_0: _elm_lang$html$Html$text(
												A2(
													_elm_lang$core$Basics_ops['++'],
													'Error: ',
													_elm_lang$core$Basics$toString(model.metaThingsApiError))),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Json editor online'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
												...
												},
												{
													...
													_0: A2(
														_elm_lang$html$Html$a,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$href('http://www.jsoneditoronline.org/?id=3e4dbce6f34017948c0a5ea43bcaf141'),
																_1: {ctor: '[]'}
															}
														},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Edit Json'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}),
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('In case the Json file is broken, replace it with:'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
...
var _lucamug$elm_meta_json_decoder$Main$NewMetaThingsData = function (a) {
	return {ctor: 'NewMetaThingsData', _0: a};
};
var _lucamug$elm_meta_json_decoder$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'NewMetaThingsData':
				var _p1 = _p0._0;
				if (_p1.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								metaThingsApiStatus: _lucamug$elm_meta_json_decoder$Main$Done,
								metaThings: _elm_lang$core$Maybe$Just(_p1._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								metaThingsApiStatus: _lucamug$elm_meta_json_decoder$Main$Error,
								metaThingsApiError: _elm_lang$core$Maybe$Just(_p1._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'FetchMetaThingsData':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{metaThingsApiStatus: _lucamug$elm_meta_json_decoder$Main$Fetching, metaThings: _elm_lang$core$Maybe$Nothing, metaThingsApiError: _elm_lang$core$Maybe$Nothing}),
					_1: A2(
						_elm_lang$http$Http$send,
						_lucamug$elm_meta_json_decoder$Main$NewMetaThingsData,
						A2(_elm_lang$http$Http$get, model.metaThingsApiUrl, _lucamug$elm_meta_json_decoder$Main$metaThings))
				};
			default:
				return {
					ctor: '_Tuple2',
...
if (typeof _lucamug$elm_meta_json_decoder$Main$main !== 'undefined') {
    _lucamug$elm_meta_json_decoder$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Main.Msg":{"args":[],"tags":{"ChangeMetaThingsApi":["String"],"NewMetaThingsData":["Result.Result Http.Error Main.MetaThings"],"FetchMetaThingsData":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Main.MetaThings":{"args":[],"type":"{ id : String , rev : String , name : String , data : List Main.Thing , updated : String }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Main.Thing":{"args":[],"type":"{ id : String, name : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
